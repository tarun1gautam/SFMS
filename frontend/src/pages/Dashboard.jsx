...
const setFolder = (newPath) => {
  // console.log(expoFolder, newPath);
  ...
  <div className="flex items-center gap-4">
    ...
    >
      ...
      <main className="flex-1 p-6 space-y-6 max-w-[1800px] w-full mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 bg-gray-900 p-2 border border-gray-800 rounded-2xl">
